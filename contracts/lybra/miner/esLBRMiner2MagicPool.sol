...
contract esLBRMiner2MagicPool is Ownable {
    IMagicPool public immutable magicPool;
    ...
    constructor(
        ...
        magicPool = IMagicPool(_magicPool);
    ...
    function totalStaked() internal view returns (uint256) {
        return magicPool.totalStaked();
    }

    function stakedOf(address user) public view returns (uint256) {
        return magicPool.stakedOf(user);
    }
